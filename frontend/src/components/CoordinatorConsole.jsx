...
export default function CoordinatorConsole({ lang, activeUser }) {
  ...
  const handleMandateCourse = async (officerId) => {
    try {
      ...
      alert('Training assigned to officer.');
      fetchCoordinatorData();
    } catch (err) {
      console.error(err);
    }
    ...
    <div className="space-y-6">
      ...
      <div className="hero-soft p-5">
        <div className="flex items-center justify-between">
          ...
          <span className="badge badge-default">
            {cohortData?.division_name || "Western Regional Unit"}
          </span>
        </div>
      </div>

      {/* KPI Counters: High-Contrast Flat Data Cards */}
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="data-card p-4">
          ...
          <div className="text-[11px] text-[#64748B] mt-0.5">Officers in division</div>
        </div>
        ...
        <div className="data-card p-4">
          ...
          <div className="text-[11px] text-[#64748B] mt-0.5">Completed diagnostic tests</div>
        </div>
        ...
        <div className="data-card p-4">
          ...
          <div className="text-[11px] text-[#64748B] mt-0.5">Division completion rate</div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-6 data-card p-5 space-y-3">
          <div className="flex items-center justify-between pb-2 border-b border-[#1E293B]">
            ...
            <span className="badge badge-danger text-[10px]">
              {(cohortData?.at_risk_officers || []).length} Incomplete
            </span>
          </div>
              ...
              <div key={officer.id} className="p-3 rounded bg-[#0F172A] border border-[#1E293B] flex items-center justify-between gap-3 text-xs">
                <div>
                  ...
                  <div className="text-[11px] text-[#64748B] font-mono">
                    {officer.official_id} • {officer.cadre}
                  </div>
                </div>
        ...
        {/* Question Generator: Clean Forms & Focus States */}
          ...
          <div className="space-y-3">
            ...
            <div>
              ...
              <select
                ...
                className="w-full form-control"
              >
                <option value="comp_sampling">Sampling Theory & Stratification (NSS 78th)</option>
                <option value="comp_plfs">PLFS Activity Status (Schedule 10.4)</option>
                <option value="comp_index">Price Index Compilation (CPI Handbook)</option>
                <option value="comp_asi">Annual Survey of Industries (ASI)</option>
                <option value="comp_natacc">National Accounts (SNA-2008)</option>
              </select>
            </div>
          ...
          {genResult && (
            <div className="p-3 rounded bg-[#0F172A] border border-emerald-500/40 text-xs text-emerald-300">
              ...
              <p className="text-[11px] text-[#94A3B8]">
                Sent to Review Queue for citation verification.
              </p>
            </div>
          )}
        </div>
